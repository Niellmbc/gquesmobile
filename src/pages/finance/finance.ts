...
lastcashiersatrans:any;
  ...
  ionViewDidLoad() {
    ...
    setInterval(this.getOnlineCashiers(),1000);
    setInterval( this.getTotalT(),1000);
    setInterval( this.numberofTransOfCashier(),1000);
    setInterval( this.lastQinTransFin(),1000);
    setInterval( this.lastQinReg(),1000);
		setInterval( this.LastQueue(),1000);
		setInterval( this.getLastCashiersaTrans(),1000);
  }
  ticket(){
